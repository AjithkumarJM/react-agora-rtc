...
const createPeerConnection = () => {
  let peerConnection = new RTCPeerConnection(initialProps.servers);
...
const useAgoraRTM = () => {
  ...
  //   const sendMessageToPeerFromClient = (memberId, payload) => {
  //     client.sendMessageToPeer(payload, memberId);
  //   };
  ...
  const createOffer = async (MemberId) => {
    ...
    console.log(peerConnection, client, 'pc');
  ...
  const init = async () => {
    let client = await AgoraRTM.createInstance(
      "d77778dded864b2389b71596a0b4b555"
    );
  ...
  return {
    webCam: rtmProps.peers.peer1,
    remoteCam: rtmProps.peers.peer2,
    toggleMic,
    toggleCamera,
  };
};
